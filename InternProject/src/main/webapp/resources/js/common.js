...
var MODAL_TITLE_CANCEL = "Cancel";
var MODAL_CONTENTS_CANCEL = "작성했던 내용은 저장되지 않습니다. 뒤로 돌아가시겠습니까?";

var MODAL_BUTTON_OK = "확인";
var MODAL_BUTTON_CANCEL = "취소";

$(document).ready(function() {
	CURRENT_BOARD_ID = $(location).attr("href").split(BOARD_ROOT)[1].split(BOARD_WRITE_ROOT)[0];
